function SliceTiming_mlb = MY_get_default_slicetiming_batch_struct1(all_func,Nslice,TR,slicetiming)
    ...
    SliceTiming_mlb{1}.spm.temporal.st.so = slicetiming;%%zoe reviced
%     switch sliceorder
%         case 'IA'
