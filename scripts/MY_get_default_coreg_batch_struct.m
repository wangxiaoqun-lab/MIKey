 function EPI2T2W_mlb=MY_get_default_coreg_batch_struct(ref, source, other,interp)
    ...
    EPI2T2W_mlb{1}.spm.spatial.coreg.estwrite.roptions.interp = interp;   
    EPI2T2W_mlb{1}.spm.spatial.coreg.estwrite.roptions.wrap = [0 0 0];
    EPI2T2W_mlb{1}.spm.spatial.coreg.estwrite.roptions.mask = 0;
    EPI2T2W_mlb{1}.spm.spatial.coreg.estwrite.roptions.prefix = 'coreg';
end