function EPI2Template_mlb=MY_get_default_oldnormalize_batch_struct1(ref, source, other)
    ...
    EPI2Template_mlb{1}.spm.tools.oldnorm.estwrite.roptions.bb = [ -135 -106 -158; 138   86  159];
    ...
    EPI2Template_mlb{1}.spm.tools.oldnorm.estwrite.roptions.prefix = 'n_';
