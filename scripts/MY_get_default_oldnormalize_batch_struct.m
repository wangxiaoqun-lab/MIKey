function EPI2Template_mlb=MY_get_default_oldnormalize_batch_struct(ref, source, other)
    ...
    EPI2Template_mlb{1}.spm.tools.oldnorm.estwrite.eoptions.smosrc = 8;     %  
    ...
    EPI2Template_mlb{1}.spm.tools.oldnorm.estwrite.eoptions.reg = 1;
    EPI2Template_mlb{1}.spm.tools.oldnorm.estwrite.roptions.bb =  [NaN NaN NaN
                                                         NaN NaN NaN];
    EPI2Template_mlb{1}.spm.tools.oldnorm.estwrite.roptions.vox = re_voxel(:);
    EPI2Template_mlb{1}.spm.tools.oldnorm.estwrite.roptions.interp = 0;     %2
    EPI2Template_mlb{1}.spm.tools.oldnorm.estwrite.roptions.wrap = [0 0 0];   %[0 0 0]
